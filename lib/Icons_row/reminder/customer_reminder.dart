...
class customer_reminder extends StatefulWidget {
  const customer_reminder({Key? key}) : super(key: key);
  @override
  State<customer_reminder> createState() => _customer_reminderState();
}

class _customer_reminderState extends State<customer_reminder> {
  RemiderControllercustomer customremider =
      Get.put(RemiderControllercustomer());
  @override
  void initState() {
    customremider.reminder.clear();
    customremider.today.clear();
    customremider.upcoming.clear();
    customremider.allData.clear();
    customremider.first = 50;
    customremider.get_all_remider();
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RemiderControllercustomer>(
