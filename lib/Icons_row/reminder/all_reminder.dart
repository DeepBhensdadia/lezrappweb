...
class _all_reminderState extends State<all_reminder> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RemiderController>(builder: (remider) =>  remider.reminder.isEmpty ? Center(child: CircularProgressIndicator(color: custom,),) : NotificationListener<OverscrollIndicatorNotification>(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        remider.today[index].customerName,
                                        // maxLines: 3,
                                        style: TextStyle(
                                            fontFamily: 'SF Pro Display',
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text(
                                              remider.today[index].dueDateFormatted,
                                              style: TextStyle(
                                                  fontFamily: 'SF Pro Display',
                                                  fontSize: 12,
                                                  fontWeight: FontWeight.w500,
