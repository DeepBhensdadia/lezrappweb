...
class _manage_staffState extends State<manage_staff> {
  ...
  void initState() {
    ...
    _staffcontroller.staffshow = false;
    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: GetBuilder<Staffcontroller>(
            builder: (controller) {
              return controller.staffshow == true
                  ? controller.staff.isEmpty ? Center(child: noresult()) :  ListView.builder(
                                  ...
                                  PopupMenuItem(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        ...
                                        Get.to(add_staff(staffdetails: staff));
                                      },
                                      child: Container(
                                        width: 100,
                                        height: 40,
                                                                    ...
                                                                    onconfirm:
                                                                      ...
                                                                      if (cach ==
                                                                        ...
                                                                        context
                                                                            .loaderOverlay
                                                                            .show();
                                                                        await delete_staff(companyuserid: staff.companyUserId).then(
                                                                            (value) {
