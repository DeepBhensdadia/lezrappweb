...
class customers_advance extends StatefulWidget {
  customers_advance({Key? key}) : super(key: key);

  @override
  State<customers_advance> createState() => _customers_advanceState();
}

class _customers_advanceState extends State<customers_advance> {
  late Customeradvance custmer;
  bool show = false;

  customerdata() {
    customeradv("1").then((value) {
      custmer = value;
      setState(() {
        show = true;
      });
