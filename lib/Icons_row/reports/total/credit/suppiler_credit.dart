...
class suppiler_credit extends StatefulWidget {
  suppiler_credit({Key? key}) : super(key: key);

  @override
  State<suppiler_credit> createState() => _suppiler_creditState();
}

class _suppiler_creditState extends State<suppiler_credit> {
  Totalcreditsupplier total = Get.put(Totalcreditsupplier());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: NotificationListener<OverscrollIndicatorNotification>(
        ...
        child: GetBuilder<Totalcreditsupplier>(builder: (total) => total.show == true ? ListView.builder(
