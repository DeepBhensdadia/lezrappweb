...
class customer_credit extends StatefulWidget {
  customer_credit({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: NotificationListener<OverscrollIndicatorNotification>(
        ...
        child:GetBuilder<Totalcreditcustomer>(builder: (customer) =>  customer.show == true
            ? ListView.builder(
          itemCount: customer.credit.transactions.length,
          itemBuilder: (context, index) {
            Transaction cre = customer.credit.transactions[index];
            return Column(
              children: [
                Container(
