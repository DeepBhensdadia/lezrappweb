...
class top_supplier extends StatefulWidget {
  top_supplier({Key? key}) : super(key: key);

  @override
  State<top_supplier> createState() => _top_supplierState();
}

class _top_supplierState extends State<top_supplier> {
  late TopCustomers details;
  bool show = false;
  customerdata(){
    top_customers("2").then((value){
      details = value;
      setState(() {
        show = true;
      });
