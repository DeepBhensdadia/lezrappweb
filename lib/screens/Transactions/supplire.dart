...
class Supplire_Tab extends StatefulWidget {
  const Supplire_Tab({Key? key}) : super(key: key);

  @override
  State<Supplire_Tab> createState() => _Supplire_TabState();
}

class _Supplire_TabState extends State<Supplire_Tab> {
  ...
  void initState() {
    ...
    transactionConroller.supplierpage = 0;
    transactionConroller.suppliertransaction.clear();
    transactionConroller.getpages("2");
  ...
  void _scrolllisten() {
    if (scrollcontroller.position.pixels ==
      ...
      setState(() {
        transactionConroller.supplierpage += 10;
      });
      print(transactionConroller.supplierpage);
  ...
  Widget build(BuildContext context) {
    return Obx(() => transactionConroller.suppliertransaction.isEmpty
        ? circulerprogress()
        : ListView.separated(
            controller: scrollcontroller,
            itemCount: transactionConroller.suppliertransaction.length,
            itemBuilder: (context, index) {
              Transaction about =
                  transactionConroller.suppliertransaction[index];
              return index + 1 ==
                      transactionConroller.suppliertransaction.length
                  ? transactionConroller.isloadingdata.isTrue
                      ...
                      : SizedBox()
                  : Slidable(
                      enabled: about.isDelete == 0 ? true : false,
                                        ...
                                        if (cach == cpcha.text) {
                                          ...
                                          await delete_transaction(
                                            ...
                                            Fluttertoast.showToast(
                                                msg: value.message);
                                            transactionConroller.getpages2("0");
