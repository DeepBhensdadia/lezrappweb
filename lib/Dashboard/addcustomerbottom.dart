...
class Addcustomerbottom extends StatefulWidget {
  final String? back;
  final Customer? about;
  Addcustomerbottom({super.key, this.about, this.back});

  @override
  State<Addcustomerbottom> createState() => _AddcustomerbottomState();
}

class _AddcustomerbottomState extends State<Addcustomerbottom> {
