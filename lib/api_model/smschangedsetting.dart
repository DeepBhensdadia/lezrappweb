...
//
//     final smschangesetting = smschangesettingFromJson(jsonString);

import 'dart:convert';

Smschangesetting smschangesettingFromJson(String str) => Smschangesetting.fromJson(json.decode(str));

String smschangesettingToJson(Smschangesetting data) => json.encode(data.toJson());

class Smschangesetting {
  bool? success;
  String? message;
  Profile? profile;
  ...
  factory Smschangesetting.fromJson(Map<String, dynamic> json) => Smschangesetting(
