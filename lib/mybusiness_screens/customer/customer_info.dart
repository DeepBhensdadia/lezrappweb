  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          ...
          body:
              GetBuilder<Customertransactioncontroller>(builder: (controller) {
            return Padding(
                                        ...
                                        items: List.generate(
                                          ...
                                          (index) => InvoiceItem(
                                              ...
                                              particular: customtransaction
                                                  .transactionnotdeleted[index]
                                                  .remark,
                                              credit: customtransaction.transactionnotdeleted[index].transactionType == "Due"
                                                  ? ""
                                                  : customtransaction
                                                      ...
                                                      .amount
                                                      .toString(),
                                              debit: customtransaction.transactionnotdeleted[index].transactionType ==
                                                      "Paid"
                                                  ? ""
                                                  : customtransaction
                                                      .transactionnotdeleted[
                                ...
                                children: [
                                  ...
                                  Text(
                                    customtransaction.show.isTrue
                                        ? 'Rs ${customtransaction.information.customers.first.totalAmount} ${customtransaction.information.customers.first.transactionType}'
                                                                  ...
                                                                  ? Row(
                                                                      children: [
                                                                        Image(
                                                                            ...
                                                                            width: 15,
                                                                            image:
                                                                                AssetImage("assets/icon/Texting.gif")),
                                                                        SizedBox(
                                                                          width:
                                                                              2,
                                                                        ),
                                                            ...
                                                            children: [
                                                              ...
                                                              Column(
                                                                children: [
                                                                  about.isDelete ==
                                                                          0
                                                                      ? about.transactionTracking.length ==
                                                                              2
                                                                          ? Padding(
                                                                              padding:
