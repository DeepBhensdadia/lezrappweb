...
class NewSupplierChart extends StatefulWidget {
  const NewSupplierChart({Key? key}) : super(key: key);

  @override
  State<NewSupplierChart> createState() =>
      _NewSupplierChartState();
}

class _NewSupplierChartState
    extends State<NewSupplierChart> {
          ...
          content: Container(
            ...
            child: YearPicker(
              ...
              onChanged: (DateTime dateTime) {
                ...
                _chartController.newsupplierdetail_onupdate(
  ...
  BarChart buildLineChartData() {
    final List<String> months = _chartController.newsuppli.months;
    final List<dynamic> record =
        _chartController.newsuppli.record;
  ...
  double getMaxYValue(List<dynamic> expenses) {
    double maxY = 0;
    final List<List<dynamic>> data = _chartController.newsuppli.data;
