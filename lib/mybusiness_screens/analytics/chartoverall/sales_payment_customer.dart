...
class Sales_payment_customer extends StatefulWidget {
  const Sales_payment_customer({Key? key}) : super(key: key);

  @override
  State<Sales_payment_customer> createState() => _Sales_payment_customerState();
}

class _Sales_payment_customerState extends State<Sales_payment_customer> {
          ...
          content: Container(
            ...
            child: YearPicker(
              ...
              onChanged: (DateTime dateTime) {
                ...
                _chartController
                    .Sales_purchase_and_customer_onupdate(
    ...
    return SafeArea(
      child: Scaffold(
          appBar: AppBar(
            ...
            title: Text(
              'Sales vs Payment of customer'.tr,
              style: TextStyle(
  ...
  BarChart buildLineChartData() {
    final List<String> months = _chartController.chartdatasales_paym_cus.months;
    final List<dynamic> paybleamount =
        _chartController.chartdatasales_paym_cus.payableAmount;
    final List<dynamic> paidamount =
        _chartController.chartdatasales_paym_cus.paidAmount;
...
width: 10,
  ...
  double getMaxYValue(
      List<dynamic> purchases, List<dynamic> expenses) {
    double maxY = 0;
    final List<List<dynamic>> data = _chartController.chartdatasales_paym_cus.data;
